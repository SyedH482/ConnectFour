# initializing the board using 2D arrays.
board = [[' ', ' ', ' ', ' ', ' ', ' '], [' ', ' ', ' ', ' ', ' ', ' '], [' ', ' ', ' ', ' ', ' ', ' '],
         [' ', ' ', ' ', ' ', ' ', ' '], [' ', ' ', ' ', ' ', ' ', ' '], [' ', ' ', ' ', ' ', ' ', ' '],
         [' ', ' ', ' ', ' ', ' ', ' ']]

#constants for the player's value
P1_VAL = "X"
P2_VAL = "0"
...
def select_space(board, column, player):
    ...
    if player != P1_VAL and player != P2_VAL:
        print("Trying to place an " + player + " in column " + str(column))
...
def game_is_over(board):
    ...
    return has_won(board, P1_VAL) or has_won(board, P2_VAL) or len(available_moves(board)) == 0
